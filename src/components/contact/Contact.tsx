...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_ie6ga3b', 'template_c2c73ur', formRef.current!, 'uSFYXNM-jePxfG8F2')
      .then((result) => {
        setSuccess(true);
        setError(false);
    ...
    >
      <motion.div className="textContainer">
        ...
        <motion.div className="item" variants={variants}>
          <h2>Mail</h2>
          <span>dev.doxuantruong@gmail.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Address</h2>
          <span>Hanoi, Vienam</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Phone</h2>
          <span>(+84) 928.15.2002</span>
        </motion.div>
      </motion.div>
